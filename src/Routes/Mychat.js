...
function Mychat() {
  ...
  let submitHandler = (e) => {
    e.preventDefault()
    axios.post('https://lovechat-api.onrender.com/sendchat', { "message": input },
      {
        headers: {
  ...
  let getMessage = () => {
    axios.get('https://lovechat-api.onrender.com/getchat', {
      headers: {
        'Authorization': localStorage.getItem('jwt')
      }
    })
  ...
  let deleteHandler = (id) => {
    axios.delete(`https://lovechat-api.onrender.com/delete/${id}`, {
      headers: {
        'Authorization': localStorage.getItem('jwt')
      }
    })
    ...
    <>
      ...
      <div className='main-chat-section'>
        <div className="card" style={{ width: "100%", margin: '20px 10px' , position : 'sticky' , top : '0px' , zIndex : '10'}}>
          <h5 className="card-header" style={{ fontFamily: 'monospace' }}>Pulic</h5>
